...
var cmdArgs = parseCmdArgvs(process.argv);
var webroot = cmdArgs.root ? cmdArgs.root : "/Users/wangcheng/work/github/just-for-fun";

var server = http.createServer(function(req, res){
	if(req.method.toLowerCase() == "get"){
		var urlInfo = parseUrl(req.url);
		var path = webroot + "/" + urlInfo["path"];
		if(fs.existsSync(path)){
			var pathInfo = parsePath(path);
			if(pathInfo.type == "file"){
				displayFile(pathInfo, res);
			}else if(pathInfo.type == "directory"){
				displayDirectory(pathInfo, res);
			}
		}else{
...
function displayFile(pathInfo, res){
...
function displayDirectory(pathInfo, res){
...
function parsePath(path){
	...
	pathInfo["path"] = path;
	pathInfo["subpath"] = path.replace(webroot, "");
